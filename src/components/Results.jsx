...
const Results = () => {
  return (
    <section className='w-full text-center flex jusitfy-center items-center flex-col bg-gradient-to-b from-[rgb(120,87,255)] to-[#2e2be9] p-5 font-extrabold gap-5 rounded-br-3xl rounded-bl-3xl'>
